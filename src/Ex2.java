...
public class Ex2 {
	...
	public static void main(String[] args) {
		 ...
		 * - ArrayList 와 Vector가 다른점은 Vector의 경우
...
//		System.out.println("정수 2를 지정하여 해당 요소 직접 삭제 : " + list.remove(2));
		...
		System.out.println("1번 인덱스부터 3번인덱스보다 작은 부분 리스트 추출 : " + subList);
		...
		// int indexOf(Object o) : 요소 o의 인덱스 리턴 (첫번째 인덱스부터 탐색)
...
//		}
		...
		// -> int 타입 대신 클래스타입인 Integer 사용할 경우
